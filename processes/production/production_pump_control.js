...
var PUMP_COOLDOWN_PERCENT = 10;
var PUMP_MIN_PID_PERCENT = 5;
var PUMP_MAX_PID_PERCENT = 20;
var MAIN_HEATER_RUN_PERCENT = 90;

var FEED_CYCLE_TIME_IN_SECONDS = 10;

// WARMUP PARAMETERS
var PRE_HEATER_WARMUP_P_GAIN = 0.2;
var PRE_HEATER_WARMUP_I_GAIN = 0.01;
var PRE_HEATER_WARMUP_D_GAIN = 0.0;
var PRE_HEATER_WARMUP_SET_POINT = 85; // Degrees F
var PUMP_WARMUP_PERCENT = 11;
var MAIN_HEATER_WARMUP_SECONDS = 900;
var DESIRED_FEED_ABV_WARMUP = 1; // Percent

// STARTUP PARAMETERS
var PRE_HEATER_STARTUP_P_GAIN = 0.2;
var PRE_HEATER_STARTUP_I_GAIN = 0.01;
var PRE_HEATER_STARTUP_D_GAIN = 0.0;
var PRE_HEATER_STARTUP_SET_POINT = 85; // Degrees F
var DESIRED_FEED_ABV_STARTUP = 8; // Percent
var PUMP_STARTUP_P_GAIN = -0.09;
var PUMP_STARTUP_I_GAIN = -0.002;
var PUMP_STARTUP_D_GAIN = 0.0;
var SUMP_TEMP_BP_OFFSET_STARTUP = 1.0;
